            ...
            <div class="app-brand demo">
              ...
              <span class="app-brand-logo demo" style="width: 50px; height: 50px;">
                  <img src="{{ asset('assets/img/logo.png') }}" alt="logo" width="50">
                    ...
                    <span class="app-brand-text demo menu-text fw-bold" style="font-size: 11pt">مسار للإغاثة والتنمية</span>
                </a>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li>
                                    <a class="dropdown-item" href="">
                                        <i class="ti ti-user me-3 ti-md"></i><span class="align-middle">إعدادات الحساب</span>
                                    </a>
                                </li>
                ...
                <footer class="content-footer footer bg-footer-theme">
                    <div class="container-xxl">
                        <div
                            ...
                            <div class="text-body">
                                made with ❤️ by <a href="https://www.facebook.com/sohaibaqad" target="_blank" class="footer-link">Sohaib Alaqad</a> ,
                                ©
                                <script>
                            ...
                            <div class="d-none d-lg-inline-block">
                                <a href="https://api.whatsapp.com/send?phone=970597746573"
                                   target="_blank" class="footer-link d-none d-sm-inline-block">
                                    الدعم الفني</a>
                            </div>
                        </div>
                    </div>
