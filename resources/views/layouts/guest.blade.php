...
<nav class="px-4 py-3 navbar navbar-expand-lg navbar-dark bg-dark fixed-top px-lg-5 py-lg-0">                <a href="" class="p-0 navbar-brand">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="{{route('reservation.step1')}}" class="px-4 py-2 btn btn-primary">Book A Table</a>
                </div>
            </nav>
