...
if (typeof $ !== 'undefined') {
  $(function () {
    ...
    if (searchInput.length) {
      ...
      //       if (i.id_number.toLowerCase().startsWith(q.toLowerCase())) {
      //         matches.push(i);
      //       } else if (
      //         !i.id_number.toLowerCase().startsWith(q.toLowerCase()) &&
      //         i.id_number.toLowerCase().includes(q.toLowerCase())
      //       ) {
      //         matches.push(i);
      //         matches.sort(function (a, b) {
      //           return b.id_number < a.id_number ? 1 : -1;
      //         });
      //       } else {
      //         return [];
      //       }
        ...
        var filterConfig = function (data) {
            return function findMatches(q, cb) {
                ...
                data.filter(function (i) {
                    ...
                    const idMatch = i.id_number.toString().includes(query);
        ...
        searchInput
          .typeahead(
            ...
            // persons
            {
              ...
              display: 'id_number',
              limit: 5,
              source: filterConfig(searchData.persons),
              templates: {
                header: '<h6 class="suggestions-header text-primary mb-0 mx-4 mt-3 pb-2">المستفيدين</h6>',
                suggestion: function ({ url, icon, id_number, name }) {
                  return (
                    '<a href="' +
                    url +
                    '">' +
                ...
                notFound:
                  ...
                  '<h6 class="suggestions-header text-primary mb-2">المستفيدين</h6>' +
                  '<p class="py-2 mb-0"><i class="ti ti-alert-circle ti-xs me-2"></i>لا يوجد بيانات مطابقة</p>' +
                  '</div>'
              }
            },
            // // Files
